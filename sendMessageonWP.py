...
phoneNumber = str(input(
    'What number would you like to text? number must include the country calling code  '))
numberOfMessages = int(
    input('How many times would you like to send a message?  '))
startingHour = int(input(
    'This script sends messages randomly between 2 hours.\nWhat hour would you like to start?  '))
